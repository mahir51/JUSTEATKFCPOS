 ...
 public void addtable(int id, String name, int qty, double price) {
   ...
   public void Bill() {
        ...
        try {
           ...
           b.setText("                                     JUST EAT \n");
            b.setText(b.getText() + "                         1230, College Road, \n");
            b.setText(b.getText() + "                         Tongi, Gazipur. \n");
            b.setText(b.getText() + "                         +8801725437438 \n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Thanks For Your Purchase!"+"\n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Software by Mahir & Mili"+"\n");
   ...
   public void pay(){
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        addtables(9, "Zinger Wrap  ", i, 4.99);
